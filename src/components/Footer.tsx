      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.facebook.com/rdgoseguros"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-secondary flex items-center justify-center transition-all"
              >
              ...
              <a
                href="https://www.linkedin.com/company/rdgoseguros"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-secondary flex items-center justify-center transition-all"
              >
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="text-sm text-white/60 space-y-2">
            <p>
              <strong className="text-white">RDGO Exclusive Corretora de Seguros</strong>
            </p>
            <p>CNPJ: 22.638.859/0001-63 | SUSEP: 232147860</p>
